<?php
    ...
    */
    ...
    $app->get('/auth', function () use ($app) {
        $app->render('partials/auth.twig', array(
    ...
    $app->get('/about', function () use ($app) {
        $app->render('partials/about.twig', array(
            "section"=>$app->environment()->offsetGet("PATH_INFO"),
            "user" => $_SESSION['user']
        ));
    });
    ...
    $app->get('/privacy', function () use ($app) {
        $app->render('partials/privacy.twig', array(
            "section"=>$app->environment()->offsetGet("PATH_INFO"),
            "user" => $_SESSION['user']
        ));
    });
    ...
    $app->get('/terms', function () use ($app) {
        $app->render('partials/terms.twig', array(
            "section"=>$app->environment()->offsetGet("PATH_INFO"),
            "user" => $_SESSION['user']
        ));
    });
    ...
    $app->get('/contact', function () use ($app) {
        $app->render('partials/contact.twig', array(
            "section"=>$app->environment()->offsetGet("PATH_INFO"),
            "user" => $_SESSION['user']
        ));
    });
